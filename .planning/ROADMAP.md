...
Plans:
- [x] 02-01-PLAN.md — Create Brewfile from setup script arrays; fix .gitignore for lazy-lock.json; add .gitattributes
...
- [x] 04-03-PLAN.md — Gap closure: remove stale yabai/ directory and update planning artifacts
