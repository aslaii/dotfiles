...
- [x] 02-02-PLAN.md — Migrate bootstrap script to brew bundle; generate Brewfile.lock.json; verify Neovim lockfile
...
| 2. Declarative Package and Plugin Management | 1/2 | In Progress | - |
