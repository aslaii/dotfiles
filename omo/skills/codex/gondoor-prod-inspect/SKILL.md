...
__OMO_HOME__/.codex/skills/gondoor-prod-inspect/scripts/prod_readonly.sh logs 200
__OMO_HOME__/.codex/skills/gondoor-prod-inspect/scripts/prod_readonly.sh errors 200
```

When an app name is known:

```bash
__OMO_HOME__/.codex/skills/gondoor-prod-inspect/scripts/prod_readonly.sh describe <app>
__OMO_HOME__/.codex/skills/gondoor-prod-inspect/scripts/prod_readonly.sh logs 300 <app>
__OMO_HOME__/.codex/skills/gondoor-prod-inspect/scripts/prod_readonly.sh errors 300 <app>
```
