...
```bash
git -C __OMO_HOME__/work/mobii/ramiro-law log --oneline \
...
```bash
git -C __OMO_HOME__/work/mobii/ramiro-law worktree list --porcelain
```
...
```bash
git -C __OMO_HOME__/work/mobii/ramiro-law worktree list --porcelain | sed -n '1,120p'
```
...
- Include history from:
  - `__OMO_HOME__/work/mobii/gondoor-mono` using `origin/main`
  - `https://github.com/Gondoor/Gondoor-Template.git` cloned/fetched at `/tmp/Gondoor-Template`
  - `__OMO_HOME__/work/mobii/ramiro-law` using `origin/dev`
...
- Discover Gondoor worktrees from `__OMO_HOME__/work/mobii/gondoor-mono` and Ramiro worktrees from `__OMO_HOME__/work/mobii/ramiro-law`, including Superpowers worktrees registered by `git worktree list`.
