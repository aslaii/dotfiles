...
switch_github_account "jericho-seafair" "Jericho Bermas" "jericho@crew.seafairyachts.com"
...
tmux send-keys -t "$PANE_API" "cd \"$PROJECT_ROOT/visitors-management-app\" && npm run dev" C-m
