...
tmux send-keys -t "$SESSION_NAME":Servers.2 "cd ~/work/rcb-estimator/ && pnpm dev" C-m
tmux split-window -v -t "$SESSION_NAME":Servers.2

tmux send-keys -t "$SESSION_NAME":Servers.3 "cd ~/work/rcb-estimator/ && pnpm run db:studio" C-m
...
tmux send-keys -t "$SESSION_NAME":API "cd ~/work/rcb-estimator/ && clear" C-m

# Create the Portal window
tmux new-window -t "$SESSION_NAME" -n Web
tmux send-keys -t "$SESSION_NAME":Web "cd ~/work/rcb-estimator/ && clear" C-m
