...
tmux send-keys -t "$SESSION_NAME":Servers.2 "cd ~/work/vublox/vublox-api/ && npm run start" C-m
tmux split-window -v -t "$SESSION_NAME":Servers.2

tmux send-keys -t "$SESSION_NAME":Servers.3 "cd ~/work/vublox/vublox-web/ && npm run start" C-m
...
tmux send-keys -t "$SESSION_NAME":API "cd ~/work/vublox/vublox-api/ && clear" C-m

# Create the Portal window
tmux new-window -t "$SESSION_NAME" -n Web
tmux send-keys -t "$SESSION_NAME":Web "cd ~/work/vublox/vublox-web/ && clear" C-m
