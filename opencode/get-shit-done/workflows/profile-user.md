...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to $HOME/.config/opencode/CLAUDE.md for all projects"
...
Display: "✓ Added profile section to $HOME/.config/opencode/CLAUDE.md"
...
Artifacts:
  ...
  ✓ Global CLAUDE.md        $HOME/.config/opencode/CLAUDE.md
```
