...
<!-- For checkpoint task examples and patterns, see @$HOME/.gemini/get-shit-done/references/checkpoints.md -->
...
See `$HOME/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `$HOME/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `$HOME/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
