...
See $HOME/.gemini/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using $HOME/.gemini/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using $HOME/.gemini/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from $HOME/.gemini/get-shit-done/templates/discovery.md
...
Use $HOME/.gemini/get-shit-done/templates/discovery.md.
